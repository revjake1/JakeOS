...
- [ ] 4.3  **Calendar surface** — Google Calendar OAuth scope wired; show today + condensed upcoming; "add this email as event" prompt path stubbed. Implementation landed in change `jakeos-calendar-module` (sidecar `9f0c9b7`, web `77b9779`); e2e verification at https://jakeos.jakehallman.com pending Jake.
